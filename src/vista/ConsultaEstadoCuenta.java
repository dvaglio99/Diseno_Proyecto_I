 ...
 */
public class ConsultaEstadoCuenta extends javax.swing.JFrame {
  ...
  public void llenarCbxCuentas() {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Consultar Estado de una Cuenta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaEstadoCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaEstadoCuenta().setVisible(true);
            }
        });
    }
