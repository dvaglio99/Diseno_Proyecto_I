 ...
 */
public class ConsultarInformacionCuentas extends javax.swing.JFrame {
  public ConsultarInformacionCuentas() {
    initComponents();
    llenarCbxCuentas();
  }
  ...
  public void llenarCbxCuentas() {
    ...
    private void initComponents() {
        ...
        tablaInformeCuentaParticular = new javax.swing.JTable();
        ...
        lblTitulo.setText("Consultar Informacion de una Cuenta en Particular");
        ...
        tablaInformeCuentaParticular.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tablaInformeCuentaParticular);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarInformacionCuentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarInformacionCuentas().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable tablaInformeCuentaParticular;
