 ...
 */
public class ConsultarSaldoCuentaDivisaExtranjera extends javax.swing.JFrame {
  public ConsultarSaldoCuentaDivisaExtranjera() {
    initComponents();
    llenarCbxCuentas();
  }
  ...
  public void llenarCbxCuentas() {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Consultar Saldo Actual de una Cuenta (Divisa Extranjera)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarSaldoCuentaDivisaExtranjera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarSaldoCuentaDivisaExtranjera().setVisible(true);
            }
        });
    }
